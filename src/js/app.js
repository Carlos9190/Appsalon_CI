...
function iniciarApp() {
    ...
    tabs(); //cambia secciones con click
...
function botonesPaginador() {
    const paguinaAnterior = document.querySelector('#anterior');
    const paguinaSiguiente = document.querySelector('#siguiente');
...
function seleccionarServicio(servicio) {
    ...
    //Identidicar el elemento al que se le da click
...
function seleccionarFecha() {
    ...
    inputFecha.addEventListener('input', function (e) {
        ...
        if ([6, 0].includes(dia)) {
            e.target.value = '';
            mostrarAlerta('Fines de semana no hay servicio', 'error', '.formulario');
        } else {
...
function seleccionarHora() {
    ...
    inputHora.addEventListener('input', function (e) {
        ...
        if (hora < 10 || hora > 18) {
            e.target.value = '';
            mostrarAlerta('Hora no válido', 'error', '.formulario');
        } else {
...
function mostrarAlerta(mensaje, tipo, elemento, desaparece = true) {
    //Previene generar más de una alerta
